function [af,V,Ct,Lvectnew,xnew] = TubeTalkerAC(x,phi,ne,ft,q,lc,ac,mc,rc,sc,np,pg,lg,rg,pm,lm,rm);
%AC means that an area compressor is built in to the vowel area calculation
