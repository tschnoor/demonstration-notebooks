function [h,z,f,D,h_alt,Zrad] = VokalTraktF(ARvect,LTvect,cutoff,maxF)
...
r = 408;
%Ft = 200;
disp('Running the yielding wall for children!!');
Ft = 250;  %from running impulse repsonses on child vocal tract and recordings
%Ft = 340; 
Fw = 15;
