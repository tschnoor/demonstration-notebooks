function [S,B,K,P,fmts,Press,Flow] = sens_functions(ar,lv,wtype)
...
[tf, zin,f,D, tf_alt] = VokalTraktM(ar,xvect,Nloss,9000);
...
for i=1:6
   if(i <= length(fmts))
       fmts(i);
      [Po,Uo,sens,kin,pot] = sensitivity(ar,xvect,fmts(i),Nloss,9000);
