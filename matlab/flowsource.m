...
% Author: B. Story, 09.20.10
% Function to calculate a glottal flow signal to be used as a source for
% Waveguide.m; Based on Titze, Mapes, and Story, (1994). J. Acoust. Soc.
% Am.
%Inputs:
% source_params is a two column matrix where col 1 is the Fo and col 2 is
% the flow amplitude
% Fsp = sampling frequency of the source params (e.g. 200 Hz)
% Fs = audio sampling frequency (e.g. 44100 Hz)

%Example function call: 
% ug = flowsource(source_params,200,44100);
